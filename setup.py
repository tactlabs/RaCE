...
setuptools.setup(
    name="RaCE",                     # This is the name of the package
    version="0.0.1",                        # The initial release version
    author="Featureprenuer",                     # Full name of the author
    description="Random Code Emitter",
    long_description=long_description,      # Long description read from the the readme file
    long_description_content_type="text/markdown",
    packages=setuptools.find_packages(include=["RaCE", "RaCE.*"]),    # List of all python modules to be installed
    classifiers=[
    ...
    py_modules=["RaCE"],             # Name of the python package
